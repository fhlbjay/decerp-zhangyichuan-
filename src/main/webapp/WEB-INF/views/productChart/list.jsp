    ...
    <script type="text/javascript">
    	$(function(){
            ...
            $(".btn_bar").click(function () {
                ...
                var url = "/chart/productChartByBar.do?" + param;
                $.dialog.open(url, {
                    id: 'ooxx',
                    title: '产品报表柱状图',
                    width: 850,
            ...
            $(".btn_pie").click(function () {
                var param = $("#searchForm").serialize();
                var url = "/chart/productChartByPie.do?" + param;
                $.dialog.open(url, {
                    id: 'ooxx',
                    title: '产品报表餅图',
                    width: 850,
...
<body>
<form id="searchForm" action="/chart/productChart.do" method="post">
    <div id="container">
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%"
                    ...
                    <c:forEach items="${charts}" var="saleChart">
                        <tr>
                            ...
                            <td>${saleChart.totalCostAmount}</td>
