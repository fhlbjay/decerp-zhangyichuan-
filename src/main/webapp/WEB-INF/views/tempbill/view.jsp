...
<body>
<form name="editForm" action="/tempbill/saveOrUpdate.do" method="post" id="editForm">
    <input type="hidden" name="id" value="${tempbill.id}">
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <input type="hidden" value="${tempbill.id}" name="id">

                <tr>
                    <td class="ui_text_rt" width="140">订单编号</td>
                    <td class="ui_text_lt">
                        <input name="sn" value="${tempbill.sn}" class="ui_input_txt02"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="text" value="${tempbill.vip.name}" class="ui_input_txt02"/>
                    </td>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input name="vdate" value="<fmt:formatDate value="${tempbill.vdate}" pattern="yyyy-MM-dd"/>"
                    ...
                    <td>
                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                            ...
                            <tr>
                                ...
                                <td><span tag="brand">${tempbill.product.brandName}</span></td>
                            ...
                            <c:if test="${not empty tempbill}">
                                <c:forEach items="${tempbill.items}" var="item">
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input disabled="true" readonly="true" class="ui_input_txt02" tag="name"
